...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Agents IA — Prospection Bladers × Maketou" },
      {
        name: "description",
        content:
          "Pilotage des agents IA de prospection : catalogue produit, suivi des leads WhatsApp et conversion.",
      },
      { name: "theme-color", content: "#14161c" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Agents IA" },
